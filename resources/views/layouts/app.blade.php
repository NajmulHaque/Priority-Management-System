...
<head>
    ...
    <title>{{ config('app.name', 'Priority Management System') }}</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" id="menubar">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Priority Management System') }}
                </a>
